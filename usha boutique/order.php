...
<html>
	...
	<body>
		...
		<?php 
			...
			$query=mysqli_query($conn,"select max(oid) as id from place");
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 banner">
					<p class="text-center" style="padding-top:225px">SHOP HERE</p>
				</div>
			</div>
		</div>
		<!--//banner-->
		...
		<div class="container-fluid" id="main">
			<form action="placed.php" enctype="multipart/form-data" method="POST">
				<div class="row">
					<div class="col-md-4">
					</div>
					<div class="col-md-4">
		...
		<div class="container-fluid" style="background-color:white;">
			<div class="form-group row">
				...
				<div class="col-md-5">
					<input type="hidden" class="form-control" name="oid" value="<?php echo $id; ?>" readonly>
					<input type="number" class="form-control" placeholder="Between 1 and 10" min="1" max="10" name="designs">
				</div>
			...
			<div class="form-group row">
				...
				<div class="col-md-5">
					<input type="file" class="form-control" name="snap" accept="image/*" required>
			...
			<div class="form-group row">
				...
				<div class="col-md-5">
					<textarea class="form-control" rows="4" name="details" placeholder="Add anything you want to change in design according to yourself..."></textarea>
			...
			<div class="form-group row">
				...
				<div class="col-md-5">
					...
					<label class="checkbox-inline" style="font-size:20px;"><input type="checkbox" style="width:15px;height:21px;" name="chk[]" value="None">Nothing</label><span class="help-block">Select 'Nothing' if you want nothing**</span>
				</div>
				<div class="col-md-4"></div>
			</div>
			<div class="form-group row">
				<div class="col-md-3"></div>
				<div class="col-md-5"><button type="submit" class="btn btn-primary">Place your order</button></div>
				<div class="col-md-4"></div>
			</div>
			</form>	
		</div>
