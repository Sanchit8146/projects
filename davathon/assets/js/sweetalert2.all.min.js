!(function(t, e) {
	...
	function Z(t, e) {
		...
		switch (e) {
			...
			case "radio":
				return (
					t.querySelector(".".concat(_.radio, " input:checked")) ||
					t.querySelector(".".concat(_.radio, " input:first-child"))
				);
			case "range":
	...
	function it(t) {
		Xe.isVisible() && ct !== t.target.value && Xe.resetValidationMessage(),
			(ct = t.target.value);
	}
	function rt(t, e) {
	...
	var ct,
		...
		pt = '\n <div aria-labelledby="'
			...
			.concat(_.header, '">\n     <ul class="')
			.concat(_["progress-steps"], '"></ul>\n     <div class="')
			.concat(_.icon, " ")
			.concat(F.error, '"></div>\n     <div class="')
			.concat(_.icon, " ")
			.concat(F.question, '"></div>\n     <div class="')
			.concat(_.icon, " ")
			.concat(F.warning, '"></div>\n     <div class="')
			.concat(_.icon, " ")
			.concat(F.info, '"></div>\n     <div class="')
			.concat(_.icon, " ")
			.concat(F.success, '"></div>\n     <img class="')
			.concat(_.image, '" />\n     <h2 class="')
			.concat(_.title, '" id="')
			...
			.concat(_.footer, '"></div>\n   <div class="')
			.concat(_["timer-progress-bar"], '"></div>\n </div>\n')
			.replace(/(^|\n)\s*/g, ""),
		ft = function(t) {
			var e;
			if (
				...
				h.appendChild(n),
					(i = t),
					(r = W()).setAttribute("role", i.toast ? "alert" : "dialog"),
					r.setAttribute("aria-live", i.toast ? "polite" : "assertive"),
					i.toast || r.setAttribute("aria-modal", "true"),
					(a = h),
					"rtl" === window.getComputedStyle(a).direction && st(z(), _.rtl),
					(c = k()),
					(s = lt(c, _.input)),
					(u = lt(c, _.file)),
					(l = c.querySelector(".".concat(_.range, " input"))),
					(d = c.querySelector(".".concat(_.range, " output"))),
					(p = lt(c, _.select)),
					(f = c.querySelector(".".concat(_.checkbox, " input"))),
					(m = lt(c, _.textarea)),
					(s.oninput = it),
					(u.onchange = it),
					(p.onchange = it),
		...
		if (n) {
			...
			(o = n),
				"string" == typeof (i = e.backdrop)
					...
					: i ||
					  st([document.documentElement, document.body], _["no-backdrop"]),
				!e.backdrop &&
					e.allowOutsideClick &&
					R(
	...
	var wt = {
		...
		Bt = {};
	(Bt.text = Bt.email = Bt.password = Bt.number = Bt.tel = Bt.url = function(
		t,
		e
	) {
		return (
		...
		(Bt.textarea = function(e, t) {
			if (((e.value = t.inputValue), yt(e, t), "MutationObserver" in window)) {
				var n = parseInt(window.getComputedStyle(W()).width),
					o =
						parseInt(window.getComputedStyle(W()).paddingLeft) +
						parseInt(window.getComputedStyle(W()).paddingRight);
	...
	function Et(t, e) {
		...
		e.html
			? (rt(e.html, c), X(c, "block"))
			: e.text
			? ((c.textContent = e.text), X(c, "block"))
			: G(c),
			(n = t),
			(o = e),
			(i = k()),
			(r = wt.innerParams.get(n)),
			(a = !r || o.input !== r.input),
	...
	function Tt(t, s) {
		...
		X(u), (u.innerHTML = "");
		var l = parseInt(
			void 0 === s.currentProgressStep ? St() : s.currentProgressStep
		);
			...
			s.progressSteps.forEach(function(t, e) {
				var n,
					...
					a =
						...
						st(o, _["progress-step"]),
						(o.innerHTML = n),
						o);
				if (
					(u.appendChild(a),
					e === l && st(a, _["active-progress-step"]),
					e !== s.progressSteps.length - 1)
				) {
					var c =
						((i = t),
						(r = document.createElement("li")),
						st(r, _["progress-step-line"]),
		...
		V(a, e, "header"),
			...
			(function(t) {
				...
				X(e),
					...
					J(e, "width", t.imageWidth),
					J(e, "height", t.imageHeight),
					(e.className = _.image),
					V(e, t, "image");
			})(e),
			(n = e),
			(o = C()),
			tt(o, n.title || n.titleText),
			n.title && rt(n.title, o),
			n.titleText && (o.innerText = n.titleText),
			V(o, n, "title"),
			(i = e),
			((r = M()).innerHTML = i.closeButtonHtml),
			V(r, i, "closeButton"),
			tt(r, i.showCloseButton),
	...
	function Ot(t, e) {
		...
		(n = e),
			...
			(r = L()),
			tt(r, i.footer),
			i.footer && rt(i.footer, r),
			V(r, i, "footer"),
			"function" == typeof e.onRender && e.onRender(W());
	}
	function Mt() {
		return B() && B().click();
	}
	var Ht = function() {
		...
		Rt = function(t, e) {
			(t.className = ""
				...
				e.toast
					? (st([document.documentElement, document.body], _["toast-shown"]),
					  st(t, _.toast))
					: st(t, _.modal),
				V(t, e, "popup"),
				"string" == typeof e.customClass && st(t, e.customClass),
				e.icon && st(t, _["icon-".concat(e.icon)]);
		};
	function Dt() {
		var t = W();
		t || Xe.fire(), (t = W());
	...
	function Nt() {
		return new Promise(function(t) {
			...
			(Wt.restoreFocusTimeout = setTimeout(function() {
				Wt.previousActiveElement && Wt.previousActiveElement.focus
					? (Wt.previousActiveElement.focus(),
					  (Wt.previousActiveElement = null))
	...
	function Jt() {
		...
		if (t) {
			...
			t.showConfirmButton ||
				...
				ut([e.popup, e.actions], _.loading),
		...
		null === Y.previousBodyPadding &&
			...
			(document.body.style.paddingRight = "".concat(
				Y.previousBodyPadding +
					(function() {
						var t = document.createElement("div");
						(t.className = _["scrollbar-measure"]),
	...
	var re = function(t, e, n, o) {
			(Wt.swalCloseEventFinishedCallback = oe.bind(null, t, n, K(), o)),
				e.addEventListener(gt, function(t) {
					t.target === e &&
						(Wt.swalCloseEventFinishedCallback(),
						delete Wt.swalCloseEventFinishedCallback);
				});
		},
		ae = function(t, e) {
			setTimeout(function() {
	...
	function pe(t) {
		...
		"function" == typeof t.onBeforeOpen && t.onBeforeOpen(n),
			...
			K() ||
				Wt.previousActiveElement ||
				(Wt.previousActiveElement = document.activeElement),
	...
	var Ce = function(t, e) {
			gt && et(e)
				? ((t.style.overflowY = "hidden"), e.addEventListener(gt, fe))
		...
		ke = function(t, e) {
			!(function() {
				if (
					...
					!j(document.body, _.iosfix)
				) {
					var t = document.body.scrollTop;
					(document.body.style.top = "".concat(-1 * t, "px")),
						st(document.body, _.iosfix),
						ee();
				}
			})(),
				"undefined" != typeof window &&
		...
		xe = function(t, e, n) {
			st(t, n.showClass.backdrop),
				...
				st([document.documentElement, document.body], _.shown),
				n.heightAuto &&
					n.backdrop &&
					!n.toast &&
					st([document.documentElement, document.body], _["height-auto"]);
		},
		Pe = function(t) {
		...
		Me = function(e, t, n) {
			(t.showLoaderOnConfirm && Dt(), t.preConfirm)
		...
		ze = function(n, o, i) {
			o.container.onclick = function(t) {
				...
				Ue
					? (Ue = !1)
					: t.target === o.container && N(e.allowOutsideClick) && i(U.backdrop);
			};
		};
	...
	var Ze,
		...
		$e = Object.freeze({
			...
			_main: function(t) {
				!(function(t) {
					for (var e in t)
						Ft((i = e)) || R('Unknown parameter "'.concat(i, '"')),
							t.toast &&
								((o = e),
								-1 !== Qt.indexOf(o) &&
									R(
					...
					Wt.currentInstance && Wt.currentInstance._destroy(),
					(Wt.currentInstance = this);
				var e = (function(t) {
				...
				de(e),
					Object.freeze(e),
					Wt.timeout && (Wt.timeout.stop(), delete Wt.timeout),
					clearTimeout(Wt.restoreFocusTimeout);
				var n = (function(t) {
					var e = {
						popup: W(),
						container: z(),
			...
			_destroy: function() {
				...
				e &&
					(t.popup &&
						...
						(Wt.swalCloseEventFinishedCallback(),
						delete Wt.swalCloseEventFinishedCallback),
					Wt.deferDisposalTimer &&
						(clearTimeout(Wt.deferDisposalTimer), delete Wt.deferDisposalTimer),
