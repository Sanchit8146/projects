		...
		jQuery(".mean-menu").meanmenu({ meanScreenWidth: "991" }),
			e(window).on("scroll", function() {
				e(this).scrollTop() > 120
					? e(".nav").addClass("is-sticky")
					: e(".nav").removeClass("is-sticky");
			}),
			...
			e(".home-slides").on("translate.owl.carousel", function() {
				e(".home-slides p")
					...
					e(".home-slides ul")
						...
						.css("opacity", "0"),
					e(".home-slides .btn, .home-slides .video-btn")
						.removeClass("animated fadeInDown")
						.css("opacity", "0"),
					e(".home-slides .banner-image img")
						.removeClass("animated fadeInUp")
						.css("opacity", "0");
			}),
			...
			setInterval(function() {
				var s, o, t, a, n, i, l;
				(s = new Date("March 19, 2020 07:00:00")),
					(s = Date.parse(s) / 1e3),
					(o = new Date()),
					(t = s - (o = Date.parse(o) / 1e3)),
					(a = Math.floor(t / 86400)),
					(n = Math.floor((t - 86400 * a) / 3600)),
					(i = Math.floor((t - 86400 * a - 3600 * n) / 60)),
					(l = Math.floor(t - 86400 * a - 3600 * n - 60 * i)),
					n < "10" && (n = "0" + n),
					i < "10" && (i = "0" + i),
					l < "10" && (l = "0" + l),
					e("#days1").html(a + "<span>Days</span>"),
					e("#hours1").html(n + "<span>Hours</span>"),
					e("#minutes1").html(i + "<span>Minutes</span>"),
					e("#seconds1").html(l + "<span> Seconds</span>");
			}, 1e3),
			(function(e) {
				e(".tab ul.tabs")
					.addClass("active")
					.find("> li:eq(0)")
					.addClass("current"),
					e(".tab ul.tabs li a").on("click", function(s) {
						...
						o.find("ul.tabs > li").removeClass("current"),
							...
							o
								.find(".tab_content")
								.find("div.tabs_item")
								.not("div.tabs_item:eq(" + t + ")")
								.slideUp(),
							o
								.find(".tab_content")
								.find("div.tabs_item:eq(" + t + ")")
								.slideDown(),
							s.preventDefault();
					});
			})(jQuery),
